...
def rebuild_topology():
    ...
    try:
        from agent_app.models.collect import AgentCollect
        from agent_app.models.agent_instance import AgentInstance
    except ImportError:
        logger.warning("[Topology] agent_app models not available")
        return
