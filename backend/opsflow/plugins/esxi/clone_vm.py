    ...
    def get_form_config(cls):
        return [
            ...
            FormItem(
                ...
                attrs={"placeholder": "输入源虚拟机名称", "placeholder_en": "Enter source VM name"},
            ...
            FormItem(
                ...
                name="新虚拟机名称",
                name_en="New VM Name",
                attrs={"placeholder": "输入新虚拟机名称", "placeholder_en": "Enter new VM name"},
            ...
            FormItem(
                ...
                attrs={"placeholder": "可选，默认与源相同", "placeholder_en": "Optional, same as source by default"},
                col=6,
            ),
            FormItem(
                tag_code="power_on",
