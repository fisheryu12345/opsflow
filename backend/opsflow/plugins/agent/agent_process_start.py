    ...
    def get_form_config(cls):
        return [
            FormItem(
                ...
                name="目标主机",
                name_en="Target Host",
                attrs={"placeholder": "目标主机 IP", "placeholder_en": "Target host IP"},
                default="",
            ),
            FormItem(
                ...
                attrs={"placeholder": "systemd unit 名（如 nginx.service）或应用名", "placeholder_en": "systemd unit name (e.g. nginx.service) or app name"},
                default="",
            ),
            FormItem(
                tag_code="command",
                type="input",
                name="启动命令",
                name_en="Start Command",
                attrs={"placeholder": "无 systemd 时的启动命令（如 nohup /opt/app/start.sh &）", "placeholder_en": "Start command without systemd (e.g. nohup /opt/app/start.sh &)"},
                default="",
            ),
            FormItem(
                tag_code="user",
                ...
                name="运行用户",
                name_en="Run As User",
                attrs={"placeholder": "可选，以指定用户启动", "placeholder_en": "Optional, run as specified user"},
                default="",
            ),
        ]
