...
class AliyunEcsStopPlugin(BasePlugin):
    ...
    def execute(self, instance_id: str, region: str = "", force_stop: bool = False, **kwargs) -> dict:
        if not region:
        ...
        try:
            ...
            request.set_ForceStop(bool(force_stop))
            client.do_action_with_exception(request)
            return {"success": True, "data": {"instance_id": instance_id, "status": "Stopping"}, "error": ""}
