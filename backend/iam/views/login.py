...
from common.utils.json_response import ErrorResponse, DetailResponse
from common.utils.request_util import save_login_log
from common.utils.serializers import CustomModelSerializer
from common.utils.validator import CustomValidationError
...
class LoginSerializer(TokenObtainPairSerializer):
    ...
    def validate(self, attrs):
        ...
        user = IAMUsers.objects.get(username=attrs['username'])
...
class LoginView(TokenObtainPairView):
    ...
    #         user = IAMUsers.objects.get(username=username)
    #     except:
