...
class MessageCenterSerializer(CustomModelSerializer):
    ...
    def get_user_info(self, instance, parsed_query):
        ...
        # You can do what ever you want in here
        # `parsed_query` param is passed to BookSerializer to allow further querying
        from iam.views.user import UserSerializer
    ...
    def get_dept_info(self, instance, parsed_query):
        ...
        # You can do what ever you want in here
        # `parsed_query` param is passed to BookSerializer to allow further querying
        from iam.views.dept import DeptSerializer
...
class MessageCenterCreateSerializer(CustomModelSerializer):
    ...
    def save(self, **kwargs):
        ...
        for user in users:
            ...
            push_to_user(user, "notification", "new", {
                "title": data.title,
...
class MessageCenterViewSet(CustomModelViewSet):
    ...
    def retrieve(self, request, *args, **kwargs):
        ...
        from application.ws_push import push_to_user
        push_to_user(user_id, "notification", "unread", {
            "unread": unread_count,
        })
