<template>
  <div class="itsm-settings">
    <div class="itsm-settings-toolbar">
      ...
      <el-button type="primary" size="small" v-can="'itsm:escalation:manage'" @click="openDialog()"><el-icon><Plus /></el-icon> 新建</el-button>
    </div>
      ...
      <el-table :data="list" v-loading="loading" stripe size="small" style="width:100%">
        ...
        <el-table-column label="操作" width="120" fixed="right">
          <template #default="{ row }">
            <el-button size="small" text v-can="'itsm:escalation:manage'" @click="openDialog(row)">编辑</el-button>
            <el-button size="small" text type="danger" v-can="'itsm:escalation:manage'" @click="onDelete(row)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
